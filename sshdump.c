...
struct state_struct state = {
    .log_level = SSH_LOG_PROTOCOL,
    .in_port = 9000,
    .out_host = "localhost",
    .out_port = 22,
    .rsa_key_file = KEYS_FOLDER "ssh_host_rsa_key",
    .dsa_key_file = KEYS_FOLDER "ssh_host_dsa_key",
    .ecdsa_key_file = KEYS_FOLDER "ssh_host_ecdsa_key",
    .pub_key_file = KEYS_FOLDER "ssh_host_rsa_key.pub",
    .priv_key_file = KEYS_FOLDER "ssh_host_rsa_key",
    .finished = 0
};
...
int main(int argc, char **argv){
    ...
    do {
        ...
        fprintf(stderr, "Started ssh dump on port %d\n", state.in_port);
        ...
        // Do key exchange
        fprintf(stderr, "Exchanging keys on inbound connection...\n");
...
//    ssh_options_set(state->out_session, SSH_OPTIONS_USER, user);
